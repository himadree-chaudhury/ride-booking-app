...
export default function VerifyProfile() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const res = await verifyRequest(undefined).unwrap();
  ...
  return (
    <div className="grid place-content-center">
      {confirmed ? (
        <Card>
          <CardHeader>
            <CardTitle className="text-xl">Verify your profile</CardTitle>
            <CardDescription>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              We will send you an OTP at <br /> {userData?.data?.email}
            </CardDescription>
          </CardHeader>
          <CardFooter className="flex justify-end">
